...
function SegmentedDateInput({ value, onChange }) {
  ...
  const handleChange = (field, raw, maxLen, nextRef) => {
    ...
    // Smart auto-jump: if first digit is too high to be a tens digit, pad and jump
...
/* ── Segmented Date Time Input (DD/MM/YYYY HH:MM) ── */
function SegmentedDateTimeInput({ value, onChange }) {
